...
import imageUnityShaderPreFiltering from './unity_shader_pre_filtering.jpg';
import imageUnityPrewarming from './unity_prewarming.jpg';
import imageIslandCullingOverview from './island_culling_overview.jpg';
import imageProcExample from './proc-example.gif';
import imageNonDeterministicParticles from './non_deterministic_particles.jpg';
import imageUnityProjectAuditor from './unity_project_auditor.jpg';

import shaderControlUnityAssetStore from './shader_control_unity_asset_store.jpg';
...
<SizedImage src={shaderControlUnityAssetStore} alt="Shader Control on the Unity Asset Store" width="60%" />

<SizedImage src={imageUnityShaderPreFiltering} alt="unity shader pre filtering" width="100%" />
## Pre-Warming
...
<SizedImage src={imageUnityPrewarming} alt="unity prewarming" width="100%" />
...
<SizedImage src={imageIslandCullingOverview} alt="island culling overview" width="100%" />
...
<SizedImage src={imageProcExample} alt="proc example" width="100%" />
...
<SizedImage src={imageNonDeterministicParticles} alt="non deterministic particles" width="100%" />
### Asset Compression
...
<SizedImage src={imageUnityProjectAuditor} alt="unity project auditor" width="100%" />
Conclusion
